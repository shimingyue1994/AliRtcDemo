package com.yue.libalirtc.feature;
...
import static com.alivc.rtc.AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_480_640P_15;
...
public class VideoConfig implements Serializable {
    ...
    // 分辨率
    private AliRtcEngine.AliRtcVideoProfile mVideoResolution    = AliRTCSDK_Video_Profile_480_640P_15;
    // 帧率
...
//    private              int     mMirrorType         = TRTC_VIDEO_MIRROR_TYPE_AUTO;
    ...
    // 本地视频旋转角TRTC_VIDEO_ROTATION_0
    private              int     mLocalRotation      = 0;
    //远端视频旋转角度TRTC_VIDEO_ROTATION_0
...
//    }
    ...
    public void setRemoteRotation(int remoteRotation) {
        this.mRemoteRotation = remoteRotation;
    }
