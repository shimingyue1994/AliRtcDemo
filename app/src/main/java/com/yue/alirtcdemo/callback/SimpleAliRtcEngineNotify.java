package com.yue.alirtcdemo.callback;
 ...
 */
public class SimpleAliRtcEngineNotify implements AliRtcEngineNotify {
    private final  String TAG = "SimpleAliRtcEngineNotify";
